...
urlpatterns = [
    ...
    path("FAQs/<str:faqtype>/", views.Faq_View, name="faq"),
    ...
    path("Club/Approve/<str:type>/", views.setApproved, name="approve_event"),
    path("Club/Deny/<str:type>/", views.setDenied, name="deny_event"),
    ...
    path("Meetings/PLC/<int:meeting_id>/", views.Meeting_PLC_Detail, name="meeting_plc"),
    path("Meetings/PLC/modify/<int:meeting_id>/", views.Meeting_PLC_Modify, name="meeting_modify_plc"),
    path("Meetings/PLC/Confirm/<int:meeting_id>/", views.addAttendeePLC, name="plc_confirm_attendee"),
    path("Meetings/PLC/Unconfirm/<int:meeting_id>/", views.removeAttendeePLC, name="plc_unconfirm_attendee"),
